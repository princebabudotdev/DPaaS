  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-slate-900 shadow-xl p-8">
        ...
        {/* Login Button */}
        <button className="mt-6 w-full rounded-xl bg-indigo-600 py-3 text-sm font-semibold text-white hover:bg-indigo-700 transition">
          Sign in
        </button>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          ...
          <span className="text-indigo-600 hover:underline cursor-pointer dark:text-indigo-400">
            Sign up
          </span>
        </p>
      </div>
